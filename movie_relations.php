		...
		if($image_check !== false){
			...
			if($image_check["mime"] == "image/gif" ){
			 ...
			 if(move_uploaded_file($_FILES["photo_input"]["tmp_name"], $person_photo_dir .$file_name)){
				 ...
				 $photo_upload_notice="foto ülesse laadimine ei õnnestunud";
			 }
		}
...
?>
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <input type="submit" name="profile_in_movie_submit" value="Salvesta">
    </form>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
		...
		<input type="submit" name="person_photo_submit" value="Lae pilt ülesse">
